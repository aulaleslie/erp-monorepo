...
export class AddAuditColumns1766614193237 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "role_permissions" ADD "createdBy" uuid`);
        await queryRunner.query(`ALTER TABLE "role_permissions" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "role_permissions" ADD "updatedBy" uuid`);
        await queryRunner.query(`ALTER TABLE "role_permissions" ADD "deletedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "role_permissions" ADD "deletedBy" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "tenant_users" ADD "deletedAt" TIMESTAMP`);
        ...
        await queryRunner.query(`ALTER TABLE "tenant_users" ADD CONSTRAINT "UQ_8fa3e63dcfe2fe25531f8849e45" UNIQUE ("tenantId", "userId")`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tenant_users" DROP COLUMN "deletedBy"`);
        await queryRunner.query(`ALTER TABLE "tenant_users" DROP COLUMN "deletedAt"`);
        await queryRunner.query(`ALTER TABLE "tenant_users" DROP COLUMN "updatedBy"`);
        await queryRunner.query(`ALTER TABLE "tenant_users" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "tenant_users" DROP COLUMN "createdBy"`);
