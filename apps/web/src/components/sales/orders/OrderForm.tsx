...
import { salesOrdersService, SalesOrderCreatePayload, SalesOrderDetail } from "@/services/sales-orders";
...
export function OrderForm({ initialData, isEdit = false }: OrderFormProps) {
    ...
    const methods = useForm<OrderFormValues>({
        ...
        defaultValues: initialData ? {
            ...
            deliveryDate: initialData.salesHeader?.deliveryDate?.split("T")[0] || "",
    ...
    const onSubmit = async (values: OrderFormValues) => {
        try {
            if (isEdit && initialData) {
                await salesOrdersService.update(initialData.id, values);
                toast({
                    title: t("toast.success") || "Order Updated",
                    description: "Order has been updated successfully.",
                });
            } else {
                const result = await salesOrdersService.create(values as SalesOrderCreatePayload);
                toast({
                    title: t("toast.success") || "Order Created",
